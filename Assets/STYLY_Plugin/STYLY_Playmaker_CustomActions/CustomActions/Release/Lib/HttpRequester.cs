...
namespace HutongGames.PlayMaker.Actions.STYLY
{
    ...
    {
        void Get(Uri uri, Dictionary<string, string> headers, Action<HttpResponse> action);
        void Post(Uri uri, Dictionary<string, string> headers, string body, Action<HttpResponse> action);
        void Put(Uri uri, Dictionary<string, string> headers, string body, Action<HttpResponse> action);
        void Delete(Uri uri, Dictionary<string, string> headers, string body, Action<HttpResponse> action);
    }
    ...
    public class HttpRequester : IHttpRequester
    {
        ...
        private void Execute(string method, Uri uri, Dictionary<string, string> headers, UploadHandler uploadHandler, Action<HttpResponse> action)
        {
        ...
        {
            Execute("GET", uri, headers, null, action);
        }
